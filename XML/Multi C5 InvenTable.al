...
xmlport 70013 "Multi C5 InvenTable"
{
    Format = VariableText;
            ...
            tableelement(InvenTable; Item)
            {
                ...
                textelement(iGroup)   //igroup hbk
                {
                    ...
                    begin
                        ...
                        InvenTable."Gen. Prod. Posting Group" := iGroup;
                        InvenTable."VAT Prod. Posting Group" := 'Standard';
                    end;
                }
                ...
                fieldelement(VendItemNumber; InvenTable."Vendor Item No.")
                {
                ...
                textelement(UnitCode)
                {
                    ...
                    begin
                        ...
                        IF not ItemUnit.Get(inventable."No.", UnitCode) then begin  //hbk
                            ItemUnit.Init();
                            ItemUnit."Item No." := InvenTable."No.";
